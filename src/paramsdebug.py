...
random_out_file = os.getcwd() + '/../HomeCreditDefaultRisk/random_search_trials_1000.csv'
grid_out_file = os.getcwd() + '/../HomeCreditDefaultRisk/grid_search_trials_1000.csv'

import csv

# Create file and open connection
out_file = os.getcwd() + '/../HomeCreditDefaultRisk/random_search_trials.csv'
of_connection = open(random_out_file, 'w')
...
of_connection = open(grid_out_file, 'w')
writer = csv.writer(of_connection)
# Write column names
headers = ['score', 'hyperparameters', 'iteration']
writer.writerow(headers)
...
features = pd.read_csv(os.getcwd() + '/../HomeCreditDefaultRisk/application_train.csv')
...
cv_results = lgb.cv(default_params, train_set, num_boost_round=100, early_stopping_rounds=100,  metrics='auc', nfold=N_FOLDS, seed=42)
...
grid_results = grid_search(param_grid, grid_out_file)
...
random_results = random_search(param_grid, random_out_file)
...
random_results = pd.read_csv(random_out_file)
grid_results = pd.read_csv(grid_out_file)
